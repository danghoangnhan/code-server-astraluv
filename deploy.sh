...
echo "    2. Run the port-forward command above"
echo "    3. Ctrl+Shift+P → Remote-SSH: Connect to Host → kubeflow-notebook"
echo ""
echo "  code-server:"
echo "    kubectl port-forward -n ${NAMESPACE} svc/pytorch-ssh-notebook-ssh 8888:8888"
